...
public class MainActivity extends AppCompatActivity
    ...
    private Button addCashButton,addOthersButton;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addOthersButton=(Button)findViewById(R.id.addOthersButton);
        ...
        addCashButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this, DonationCashActivity.class);
                startActivity(i);
            }
        });

        addOthersButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this, DonationOthersActivity.class);
                startActivity(i);
            }
        });
